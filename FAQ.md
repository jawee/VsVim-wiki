...
Every commit in VsVim will upload a new build to the [Open VSIX Gallery](http://vsixgallery.com) (search for [VsVim](http://vsixgallery.com/extension/VsVim.Microsoft.e214908b-0458-4ae2-a583-4310f29687c3/).  If there is a bug fix or patch which isn't on the official Microsoft gallery yet you can just install the latest VsVim build from here until it makes it into the official release. The instructions for using this as a VSIX source are [documented here](http://vsixgallery.com/guide/feed/)
